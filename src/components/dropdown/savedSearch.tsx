...
const SavedSearchDropdown = (props: SavedSearchProps) => {
    const [dropdownOpen, setDropdownOpen] = React.useState(false);
    const toggle = () => {
        setDropdownOpen(!dropdownOpen)
    }
    return (
        <Dropdown isOpen={dropdownOpen} toggle={toggle} className="mr-md-3">
            ...
            <DropdownMenu className="dropdown-menu border-0 rounded py-2  save-search-menu">
                    ...
                    <DropdownItem className="d-flex drop-down-items justify-content-between align-items-center">
                        ...
                        <Col sm="9" xs="9">
                            <div className="saved-search-action  text-secondary">
                                <i className="icon-edit mr-4" onClick={() => props.toggleEditSearchModal(1)}></i>
                ...
                <Row>
                    <DropdownItem className="d-flex drop-down-items justify-content-between align-items-center">
                        ...
                        <Col sm="9" xs="9">
                            <div className="saved-search-action  text-secondary">
                                <i className="icon-edit mr-4" onClick={() => props.toggleEditSearchModal(2)}></i>
                                <i className="icon-trash"></i>
                            </div>
                        </Col>
                    </DropdownItem>
                ...
                <Row>
                    <DropdownItem className="d-flex drop-down-items justify-content-between align-items-center">
                        ...
                        <Col sm="9" xs="9">
                            <div className="saved-search-action  text-secondary">
                                <i className="icon-edit mr-4" onClick={() => props.toggleEditSearchModal(3)}></i>
                                <i className="icon-trash"></i>
                            </div>
                        </Col>
                    </DropdownItem>
                ...
                <Row>
                    <DropdownItem className="d-flex drop-down-items justify-content-between align-items-center">
                        ...
                        <Col sm="9" xs="9">
                            <div className="saved-search-action  text-secondary">
                                <i className="icon-edit mr-4" onClick={() => props.toggleEditSearchModal(4)}></i>
                                <i className="icon-trash"></i>
                            </div>
                        </Col>
                    </DropdownItem>

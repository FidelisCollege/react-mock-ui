...
const WelcomeComponent = () => {
    return (
        <Container className="h-100 d-flex justify-content-center align-items-center bg-white">
            <div className="onboard-wrapper-content">
                ...
                <div>
                    <button type="button" className="btn btn-primary text-capitalize btn-lg"> accept </button>
                </div>
            </div>

...
import AddMentorCard from "./menteeTabComponent";
import {Col} from "reactstrap";
import ChatWrapper from "../community/chatWrapper";



const MenteeRightSection = () => {
    return (
        <div className="right-section-actions flex-grow-1 overflow-auto pb-5">
            ...
            <div className="card border-0 card-purpose tab-data d-none d-lg-block mt-3">
                <div className="card-body card-shadow px-3">
                    <h3 className="card-title text-light d-flex justify-content-between text-capitalize border-0"> mentor activity</h3>
                    <hr></hr>
...
export default  MenteeRightSection;
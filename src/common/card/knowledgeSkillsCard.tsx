...
import {IconAdd, IconSkills} from "../../common";
            ...
            <div className="flex-grow-1">
                <div className="d-flex justify-content-between flex-grow-1 pb-3">
                    <div className="d-flex align-items-center">
                        <IconSkills className="mr-2 text-dark"/>
                        <p className="f-14 text-dark mb-0  text-capitalize">Knowledge & Skills</p>
                    </div>
                    <SwitchButton/>
                </div>
...
export default KnowledgeSkillsCard;

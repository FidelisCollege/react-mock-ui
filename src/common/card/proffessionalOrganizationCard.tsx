...
import {IconAdd, IconOrganization} from "../../common";
import SwitchButton from "../forms/switchButtons";



const ProffessionalOrganizationCard = () => {
            ...
            <div className="flex-grow-1">
                <div className="d-flex justify-content-between flex-grow-1 pb-3">
                    <div className="d-flex align-items-center">
                        <IconOrganization className="mr-2 text-dark"/>
...
export default ProffessionalOrganizationCard;
